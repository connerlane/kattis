...
def test_1000():
    assert approach2.solve(1000) == 4

def test_10368():
    assert approach2.solve(10368) == 6

def test_112500():
    assert approach2.solve(112500) == 6

def test_165888():
    assert approach2.solve(165888) == 7

def test_451008():
    assert approach2.solve(451008) == 7

def test_500000():
    assert approach2.solve(500000) == 6

def test_1620000():
    assert approach2.solve(1620000) == 8

def test_1764000():
    assert approach2.solve(1764000) == 8
